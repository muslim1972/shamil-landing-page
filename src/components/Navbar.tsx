        ...
        >
            <div className="container mx-auto px-4 flex items-center justify-between" dir="rtl">
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <a
                            key={link.name}
                            href={link.href}
                            className="text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors relative group"
                        >
                            {link.name}
                ...
                <div className="hidden md:block">
                    <a
                        href="#download"
                        className="flex items-center gap-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-5 py-2.5 rounded-full font-bold hover:bg-slate-800 dark:hover:bg-slate-100 transition-all shadow-lg hover:shadow-xl active:scale-95"
                    >
                        <Download size={18} />
                        ...
                        <div className="container mx-auto px-4 py-4 flex flex-col gap-4" dir="rtl">
                            ...
                            {navLinks.map((link) => (
                                <a
                                    ...
                                    className="text-slate-600 dark:text-slate-300 hover:text-primary-600 font-medium py-2 border-b border-slate-50 dark:border-slate-800 last:border-0"
                                >
                                    {link.name}
                                </a>
                            ))}
